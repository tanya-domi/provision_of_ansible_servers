...
# Use Terraform code to provision ansible Control node and Managed nodes and  install ansible on control node.
...
Make sure that PasswordAuthentication is enabled or set to yes in all servers under /etc/ssh/sshd_config file.
